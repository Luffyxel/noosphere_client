...
pub struct CefConfig {
    ...
    /// Directory containing CEF resources such as `resources.pak` and
    /// `icudtl.dat` (`Settings::resources_dir_path`).
    pub resources_dir_path: Option<PathBuf>,
    /// Directory containing CEF locale packs (`Settings::locales_dir_path`).
